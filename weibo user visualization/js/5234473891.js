            ...
            function (ec) {
                ...
                optiontool = {
					...
					legend: {
						orient : 'vertical',
						x : 'left',
						data:['小米手机2S','360安全浏览器','媒体版微博','三星 GALAXY S6','三星GALAXY Note 4','搜狗高速浏览器','微博 weibo.com']
					},
					toolbox: {
						show : true,
						feature : {
					...
					series : [
						{
							...
							data: [
									...
									{name : '360安全浏览器', value : 485},
									{name : '媒体版微博', value : 297},
									{name : '三星 GALAXY S6', value : 48},
									{name : '三星GALAXY Note 4', value : 23},
									{name : '搜狗高速浏览器', value : 729},
									{name : '微博 weibo.com', value : 16939}
								] 
						}
					]
				};
				...
				optionstatis = {
                        ...
                        series : [
                            {
                                ...
                                data:[
                                    ...
                                    {value:0, name:'2012年'},
                                    {value:0, name:'2013年'},
                                    {value:12180, name:'2014年'},
                                    {value:12293, name:'2015年'}
                                ]
                            }
                        ]
                    };
                        ...
                        series : [
                            {
                                name:'该月发帖量',
                                type:'line',
                                data:[2339,463,1187,1208,3530,777,1042,616,879,235],
                                markPoint:{
                                data:[
                    ...
                    optionmonth3 = {
                        ...
                        xAxis : [
                            {
                                type : 'category',
                                data : ['2015/5/1','2015/5/2','2015/5/3','2015/5/4','2015/5/5','2015/5/6','2015/5/7','2015/5/8','2015/5/9','2015/5/10','2015/5/11','2015/5/12','2015/5/13','2015/5/14','2015/5/15','2015/5/16','2015/5/17','2015/5/18','2015/5/19','2015/5/20','2015/5/21','2015/5/22','2015/5/23','2015/5/24','2015/5/25','2015/5/26','2015/5/27','2015/5/28','2015/5/29','2015/5/30','2015/5/31']                     
                            }
                        ],
                        yAxis : [
                            {
                        ...
                        series : [
                            {
                                name:'该日发帖量',
                                type:'line',
                                data:[38,34,49,104,133,20,134,19,10,0,16,109,30,236,300,156,99,18,62,158,149,280,128,142,251,229,267,234,62,63,0],
                                markPoint:{
                                data:[
                 ...
                 optionthird = {
					...
					legend: {
						orient : 'vertical',
						x : 'left',
						data:['今日头条','bShare分享','分享按钮','百度分享','网易新闻','凤凰网']
					},
					toolbox: {
						show : true,
						feature : {
					...
					series : [
						{
							...
							center: ['50%', '60%'],
							data:[
								{value:2521, name:'今日头条'},
								{value:155, name:'bShare分享'},
								{value:569, name:'分享按钮'},
								{value:1073, name:'百度分享'},
								{value:83, name:'网易新闻'},
								{value:1315, name:'凤凰网'}
							]
						}
