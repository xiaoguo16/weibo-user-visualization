            ...
            function (ec) {
                ...
                optiontool = {
					...
					legend: {
						orient : 'vertical',
						x : 'left',
						data:['Weico.iPhone','iPhone客户端','微博AIR','微博桌面安全版','微博 weibo.com','iPhone 6']
					},
					toolbox: {
						show : true,
						feature : {
					...
					series : [
						{
							...
							center: ['50%', '60%'],
							data: [
									{name : 'Weico.iPhone', value : 347},
									{name : 'iPhone客户端', value : 8559},
									{name : '微博AIR', value : 5029},
									{name : '微博桌面安全版', value : 543},
									{name : '微博 weibo.com', value : 4049},
									{name : 'iPhone 6', value : 2321}
								] 
						}
					]
				};
				...
				optionstatis = {
                        ...
                        series : [
                            {
                                ...
                                data:[
                                    ...
                                    {value:7633, name:'2012年'},
                                    {value:7202, name:'2013年'},
                                    {value:4781, name:'2014年'},
                                    {value:3524, name:'2015年'}
                                ]
                            }
                        ]
                    };
                        ...
                        series : [
                            {
                                name:'该月发帖量',
                                type:'line',
                                data:[0,250,457,663,794,904,796,833,773,762,715,686],
                                markPoint:{
                                data:[
                    ...
                    optionmonth3 = {
                        ...
                        xAxis : [
                            {
                                type : 'category',
                                data : ['2012/6/1','2012/6/2','2012/6/3','2012/6/4','2012/6/5','2012/6/6','2012/6/7','2012/6/8','2012/6/9','2012/6/10','2012/6/11','2012/6/12','2012/6/13','2012/6/14','2012/6/15','2012/6/16','2012/6/17','2012/6/18','2012/6/19','2012/6/20','2012/6/21','2012/6/22','2012/6/23','2012/6/24','2012/6/25','2012/6/26','2012/6/27','2012/6/28','2012/6/29','2012/6/30']
                            }
                        ],
                        yAxis : [
                            {
                        ...
                        series : [
                            {
                                name:'该日发帖量',
                                type:'line',
                                data:[30,19,17,30,24,19,26,29,30,29,39,27,29,44,54,35,21,29,25,26,26,28,32,29,33,34,30,46,33,31],
                                markPoint:{
                                data:[
