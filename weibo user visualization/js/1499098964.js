            ...
            function (ec) {
                ...
                optiontool = {
					...
					legend: {
						orient : 'vertical',
						x : 'left',
						data:['诺基亚C7','小米手机1S','iPhone 6','Weico.iPhone','S60客户端','微博 weibo.com','新浪微博4G版']
					},
					toolbox: {
						show : true,
						feature : {
					...
					series : [
						{
							...
							center: ['50%', '60%'],
							data: [
									{name : '诺基亚C7', value : 2111},
									{name : '小米手机1S', value : 1457},
									{name : 'iPhone 6', value : 113},
									{name : 'Weico.iPhone', value : 880},
									{name : 'S60客户端', value : 364},
									{name : '微博 weibo.com', value : 4400},
									{name : '新浪微博4G版', value : 191}
								] 
						}
					]
				};
                        ...
                        series : [
                            {
                                ...
                                data:[
                                    {value:1, name:'2009年'},
                                    {value:29, name:'2010年'},
                                    {value:1152, name:'2011年'},
                                    {value:5096, name:'2012年'},
                                    {value:2959, name:'2013年'},
                                    {value:570, name:'2014年'},
                        ...
                        series : [
                            {
                                name:'该月发帖量',
                                type:'line',
                                data:[222,269,244,237,376,312,525,545,541,668,602,555],
                                markPoint:{
                                data:[
                        ...
                        series : [
                            {
                                name:'该日发帖量',
                                type:'line',
                                data:[24,14,29,10,24,9,24,33,27,19,18,22,15,18,34,33,11,10,7,4,9,29,23,29,22,30,29,20,35,17,40],
                                markPoint:{
                                data:[
